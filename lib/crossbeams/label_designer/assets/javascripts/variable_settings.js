VariableSettings = (function () {
  ...
  const save = (shape) => {
    if (shape.variableBoxType()) {
      ...
      const currentValues = {
        ...
        isBarcode: String(document.querySelector('#barcode_bool').checked),
        showBarcodeText: String(document.querySelector('#barcode_text').checked),
        barcodeTop: document.querySelector('#barcode_top').value,
    ...
    if (shape) {
      ...
      if (info) {
        ...
        if (info.isBarcode === 'true') {
          document.querySelector('#barcode_bool').checked = true;
          toggleBarcodeOptions(true);
          document.querySelector('#barcode_text').checked = info.showBarcodeText;
          document.querySelector('#barcode_top').value = info.barcodeTop;
  ...
  document.getElementById('barcode_bool').addEventListener('change', function barcodeChange() {
