(function () {
  ...
  document.querySelector('.label-designer-copy-button').addEventListener('click', function () {
    const shape = myLabel.selectedShape();
    Clipboard.copy(shape);
  });
  document.querySelector('.label-designer-paste-button').addEventListener('click', function () {
  ...
  var variableDialog = $('#variable-info-dialog-form').dialog({
    autoOpen: false,
    height: 400,
    width: 350,
    modal: true,
    buttons: {
      'Save Variable Settings': saveVarSettings,
      Cancel() {
  ...
  // variableDialog.find('input:file').change(function () {
