Canvas = (function() {
  ...
  zoomPercentageSelect.addEventListener('change', function() {
  ...
  const updateRuler = (scale) => {
    ...
    document.querySelectorAll('.top-ruler label').forEach(function(elem) {
      elem.setAttribute('style', `width:${newRulerScale}px !important;`);
    });
    document.querySelectorAll('.left-ruler label').forEach(function(elem) {
