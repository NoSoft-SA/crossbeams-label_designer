...
//     // myLabel.exportToJSON(),
  ...
  console.log(labelConfig.labelDimension);
  ...
  function cleanStage(width, height) {
    ...
    drawEnv.stage.draw();
    console.log('draw stage here, before resizing');
  ...
  function doResizeCanvas(width, height, originalWidth = null, originalHeight = null) {
    ...
    console.log('DORESIZE:', myLabel, width, minwidth, myLabel.minLabelWidth);
    if (myLabel && (width >= minwidth)) {
      console.log('this should set width input');
    ...
    if (myLabel && (height >= minheight)) {
      console.log('this should set height input');
  ...
  const Label = function Label() {
    ...
    return {
      openLabel(labelConfig = undefined) {
        if (labelConfig){
          ...
          if (labelConfig.labelState === 'preview') {
            ...
            console.log('NAME',labelConfig.labelName);
            console.log('loadFromConfig dimensions');
            console.log(myLabelSize.width);
            console.log(myLabelSize.height);
            cleanStage(width, height);

            console.log('***SavePath***', labelConfig.labelName ,labelConfig.savePath);
            ...
            console.log('after open label', drawEnv.stage);
            console.log('layers', drawEnv.stage.getChildren());
            console.log('container', drawEnv.divPaper);
            drawEnv.stage.draw();
          }
        } else {
      ...
      initialise(width = undefined, height = undefined, name = undefined, id = undefined, labelJSON = undefined) {
        console.log('labelJSON', labelJSON);
        if (labelJSON) {
      ...
      loadFromJson(labelJSON) {
        ...
        this.shapes = [];
        console.log('loadFromJson dimensions');
        console.log(newLabel.labelWidth);
        console.log(newLabel.labelHeight);
