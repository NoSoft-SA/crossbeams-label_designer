(function() {
  ...
  $("input[name='textbox']").on('input', function(event){
    ...
    console.log(myLabel.selectedShape().textBox.height());
    console.log(myLabel.selectedShape().textBox.getTextHeight());
    drawEnv.stage.draw();
  });
  ...
  $('button.italic').on('click', function(){
    if ($(this).hasClass('selected')){
      ...
      $(this).addClass('selected');
      myLabel.selectedShape().textBox.fontStyle('italic');
    }
    drawEnv.stage.draw();
  });
  ...
  var Label = function Label(){
    ...
    return {
      ...
      getShapeByElem: function(elem){
        ...
        console.log(this.getShapeById(elem._id));
