...
// $('button[name=line]')
  ...
  function initLine(event) {
    ...
    currentElement = line;
    div_paper.onmousemove = drawLine;
  }
  function initRectangle(event) {
    ...
    currentElement = rect;
    div_paper.onmousemove = drawRectangle;
  }
  function initEllipse(event) {
    ...
    div_paper.onmousemove = drawEllipse;
  }
  function initTextBox(event) {
    ...
    currentElement = text;
    div_paper.onmousemove = drawTextBox;
  }
  function initVariableBox(event) {
    var text = new Konva.Text({
      x: startX,
      y: startY,
      text: 'Insert text...',
    ...
    div_paper.onmousemove = drawVariableBox;
  }
